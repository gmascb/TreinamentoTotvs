...
(function () {
    ...
    angular
        ...
        .factory('localidadeFactory', localidadeFactory);

    localidadeFactory.$inject = ['$totvsresource'];

    function localidadeFactory($totvsresource) {
        ...
        function findRecords(parameters, callback) {
            parameters.data = "rmsrestdataserver/FisMunicipioData";
